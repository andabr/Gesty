...
public class AppsLauncherActivity extends BasicMenuActivity {
   ...
   public class ActivityAdapter extends BaseAdapter implements Filterable {
       ...
       public ActivityAdapter(IconResizer resizer) {
           ...
           mOriginalValues.addAll(((GestyApp)getApplication()).getAppList());
       ...
       public Intent intentForPosition(int position) {
           ...
           if (mPackages.contains(item.className) &&
        	   ...
        	   intent.putExtra(IntentsData.GESTURE_ID, item.className);
               intent.putExtra(IntentsData.PACKAGE_ID, item.packageName);
               intent.putExtra(IntentsData.CLASS_ID, item.className);
               intent.putExtra(IntentsData.CONTACT_DETAIL_VALUE, item.className);
               intent.putExtra(IntentsData.ACTION_ID, GestureDetail.ACTION_LAUNCH_APP);
           } else {
