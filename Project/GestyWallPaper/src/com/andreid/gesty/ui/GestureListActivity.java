...
public class GestureListActivity extends BasicMenuActivity {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		intent.putExtra(IntentsData.CONTACT_ID, item.getCid());
		intent.putExtra(IntentsData.ACTION_ID, item.getActionId());
		intent.putExtra(IntentsData.CONTACT_DETAIL_ID, item.getDid());
		intent.putExtra(IntentsData.GESTURE_ID, item.getGestureId());
		intent.putExtra(IntentsData.CONTACT_DETAIL_VALUE, item.getContactDetailValue());
		intent.putExtra(IntentsData.PACKAGE_ID, item.getPackage());
		intent.putExtra(IntentsData.CLASS_ID, item.getClassName());
		intent.putExtra(IntentsData.URL_ID, item.getContactDetailValue());
