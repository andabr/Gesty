...
public class ContactPhotoLoader implements Callback {
    ...
    private final String[] COLUMNS = new String[] { CommonDataKinds.Photo._ID, CommonDataKinds.Photo.PHOTO };
...
//    private BitmapFactory.Options resample;
    ...
    public ContactPhotoLoader(Context context, int defaultResourceId) {
        ...
        mContext = context;
//        resample = new BitmapFactory.Options();
//        resample.outHeight = 44;
//        resample.outWidth = 44;
//        resample.inScaled = false;
    ...
    public Drawable getCachedDrawable(long photoId) {
    	BitmapHolder holder = mBitmapCache.get(photoId);
