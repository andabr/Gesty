...
/**
 * This is a wrapper for a native contact detail in the address book.
 *
 */
public class ContactDetail implements Serializable {
    ...
    public static final int KIND_EMAIL = 4;
    ...
    private List<GestureDetail> mGestures;
    /** contact detail id */
    private long mId;
    /**
     * 
     * Constructor.
     * @param kind - KIND_PHONE or KIND_EMAIL
     * @param type - native detail type
     * @param label - native detail label
     * @param value - native detail value
     * @param isPrimary - native detail isPrimary
    ...
    public List<GestureDetail> getGestures() {
		return mGestures;
	}
	 ...
	 * @return GestureDetail for the given action id, 
	 * or null if this action has no dedicated GestureDetails. 
	 */
